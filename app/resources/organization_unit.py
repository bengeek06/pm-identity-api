...
class OrganizationUnitListResource(Resource):
    ...
    def get(self):
        ...
        Returns:
            tuple: A tuple containing a list of serialized organization units and the
    ...
    def post(self):
        ...
        Returns:
            tuple: The serialized created organization unit and HTTP status code 201
                   on success.
...
class OrganizationUnitResource(Resource):
    ...
    Methods:
        ...
        delete():
            Delete an organization unit by its ID.
    """
    ...
    def get(self, unit_id):
        ...
        Returns:
            tuple: The serialized organization unit and HTTP status code 200 on success.
    ...
    def put(self, unit_id):
        ...
        Returns:
            tuple: The serialized updated organization unit and HTTP status code 200 on success.
                    HTTP status code 404 if the organization unit is not found.
    ...
    def delete(self, unit_id):
        ...
        Returns:
            tuple: HTTP status code 204 on success.
                    HTTP status code 404 if the organization unit is not found.
        """
        logger.info("Deleting organization unit with ID %s and all its descendants", unit_id)
        ...
        try:
            ...
            db.session.rollback()
            logger.error("Integrity error while deleting organization unit: %s", str(err))
            return {"error": "Integrity error, possibly due to foreign key constraints."}, 400
        except SQLAlchemyError as err:
            db.session.rollback()
            logger.error("Database error while deleting organization unit: %s", str(err))
            return {"error": "Database error occurred."}, 500
...
class OrganizationUnitChildrenResource(Resource):
    ...
    def get(self, unit_id):
        ...
        Returns:
            tuple: A list of serialized child organization units and HTTP status code 200.
        """
